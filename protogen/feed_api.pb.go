...
func (*SubscribeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_690fbc31cc97fd09, []int{4}
}
...
func (*SubscribeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_690fbc31cc97fd09, []int{5}
}
...
func init() {
	...
	proto.RegisterType((*SubscribeRequest)(nil), "proto.v1.SubscribeRequest")
	proto.RegisterType((*SubscribeResponse)(nil), "proto.v1.SubscribeResponse")
}
...
var fileDescriptor_690fbc31cc97fd09 = []byte{
	...
	,
}
...
type FeedAPIClient interface {
	...
	Subscribe(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (FeedAPI_SubscribeClient, error)
}
...
func (c *feedAPIClient) Subscribe(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (FeedAPI_SubscribeClient, error) {
	stream, err := c.cc.NewStream(ctx, &_FeedAPI_serviceDesc.Streams[0], "/proto.v1.FeedAPI/Subscribe", opts...)
	if err != nil {
		return nil, err
	}
	x := &feedAPISubscribeClient{stream}
...
type FeedAPI_SubscribeClient interface {
	Recv() (*SubscribeResponse, error)
	grpc.ClientStream
}

type feedAPISubscribeClient struct {
	grpc.ClientStream
}

func (x *feedAPISubscribeClient) Recv() (*SubscribeResponse, error) {
...
type FeedAPIServer interface {
	...
	Subscribe(*SubscribeRequest, FeedAPI_SubscribeServer) error
}
...
func (*UnimplementedFeedAPIServer) Subscribe(req *SubscribeRequest, srv FeedAPI_SubscribeServer) error {
...
func _FeedAPI_Subscribe_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(SubscribeRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(FeedAPIServer).Subscribe(m, &feedAPISubscribeServer{stream})
}

type FeedAPI_SubscribeServer interface {
	Send(*SubscribeResponse) error
	grpc.ServerStream
}

type feedAPISubscribeServer struct {
	grpc.ServerStream
}

func (x *feedAPISubscribeServer) Send(m *SubscribeResponse) error {
	...
	Streams: []grpc.StreamDesc{
		{
			...
			Handler:       _FeedAPI_Subscribe_Handler,
			ServerStreams: true,
		},
	},
